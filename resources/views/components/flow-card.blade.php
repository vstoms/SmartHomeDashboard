...
<button class="flow-card lux-card lux-flow rounded-2xl p-4 md:p-5 min-h-[140px] flex flex-col justify-center items-center transition-all duration-300 active:scale-95 touch-manipulation"
